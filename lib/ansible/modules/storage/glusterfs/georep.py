...
options:
    start:
        description: starts a geo-rep session with the credentials gained from the status action in the gluster enabled hosts.
    stop:
        description: stops a geo-rep session with the credentials gained from the status action in the gluster enabled hosts.
author:
